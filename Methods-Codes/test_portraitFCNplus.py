...
MODEL_FILE = '../our_models/deploy_6channels.prototxt'
PRETRAINED = '../our_models/bgr_mmask_xy.caffemodel'
net = caffe.Net(MODEL_FILE, PRETRAINED, caffe.TEST)

net.blobs['data'].reshape(1, 6, 800, 600)


import scipy.io as scio

testlistPath = '../../data/testlist.mat'
outputPath = './Output_PortraitFCNplus/'

testlist = scio.loadmat(testlistPath)['testlist'][0]

for i in range(len(testlist)):
	if os.path.exists('../../data/portraitFCN+_data/%05d.mat' % testlist[i]) is True:
		image = scio.loadmat('../../data/portraitFCN+_data/%05d.mat' % testlist[i])['img']
